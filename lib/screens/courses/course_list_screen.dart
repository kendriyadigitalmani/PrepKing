...
/// Fixed provider – matches your actual API response
...
class CourseListScreen extends ConsumerWidget {
  ...
  // Helper: Count total lessons from content_ids (serialized PHP array)
  int _getTotalContents(Map<String, dynamic> course) {
    ...
    try {
      // Handle PHP serialized string like: a:5:{i:0;i:2;i:1;i:3;...}
              ...
              data: (courses) {
                ...
                return SliverList(
                  delegate: SliverChildBuilderDelegate(
                      ...
                      final progress = userProgressAsync.value?.courseProgress[courseId] ?? 0.0;
